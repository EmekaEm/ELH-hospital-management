...
<div class="container">
  <main>
    ...
    <img src="/hbook/images/cart.jpg" alt="Cart Icon" class="icon-img" style="width: 72px; height: 57px;">
      <h2>Checkout </h2>
    </div>
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form method="post" action = "connect2.php"class="needs-validation" novalidate>
          <div class="row g-3">
            <div class="col-sm-6">
